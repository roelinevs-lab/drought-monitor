...
# We removed JSON_KEY_FILE variable because we don't need it anymore
...
def connect_to_sheet():
    ...
    try:
        # CHANGED: Load credentials from the Environment Variable (Secret)
        # We use json.loads to turn the text string back into a dictionary
        key_dict = json.loads(os.environ["GCP_SERVICE_ACCOUNT"])
        
        scope = ['https://spreadsheets.google.com/feeds', 'https://www.googleapis.com/auth/drive']
        
        # CHANGED: Use from_service_account_info instead of filename
...
def update_once():
    # CHANGED: Renamed from start_cloud_logging to update_once
    ...
    try:
        ...
        sys.exit(1) # Tell GitHub the script failed
